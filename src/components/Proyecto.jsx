    ...
    return (
        <article className="relative sm:max-w-full max-w-xl rounded-lg shadow flex items-center sm:flex-row-reverse mb-5 transition flex-col">
            ...
            <div className='p-4 flex-1 flex flex-col items-end gap-y-2'>
                ...
                <img className="mx-auto w-auto max-h-[400px] aspect-auto" src={imagen} alt={`Imagen proyecto ${titulo}`} loading='lazy' />
            </div>
            <div className="p-5 flex-1">
                ...
                <div className='mt-3 flex items-center gap-x-3'>
                    ...
                    {repo && (
                        <a href={repo} className='btn btn-sm btn-outline'>
                            <svg className='size-4' viewBox="0 0 256 250" width="256" height="250" fill="currentColor" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                    ...
                    {demo && (
                        <a href={demo} className='btn btn-sm btn-outline'>
                            <svg className='size-4' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
