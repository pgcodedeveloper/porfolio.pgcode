...
const Proyectos = () => {
    ...
    const [proyectosR,setProyectos] = useState([]);
    ...
    useEffect(() =>{
        const obtenerProyectos = async() =>{
            setCargando(true);
            try {
                const url = 'https://pgcodedeveloper-pgcodedeveloper.koyeb.app/proyectos';
                const [resProyectos] = await Promise.all([
                    fetch(url)
                ]);
                ...
                setCantPag(Math.ceil(proyectos.length / cant_por_pag));
